export default function URLImportsFeature() {
  return (
    <div className="md:max-w-3xl drop-shadow-xl bg-slate-200 dark:bg-slate-900/50 border border-slate-900 rounded-lg px-1 md:px-12 md:py-8">
      ...
      <div className="bg-slate-400/10 dark:bg-white/5 border border-slate-400 dark:border-white/30 px-2 md:px-6 py-4 rounded-md">
        <div className="flex my-2">
          <p className="text-lg md:text-xl font-semibold mr-auto my-auto">reejs i</p>
