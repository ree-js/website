  ...
  return (
    <div className="md:flex md:flex-row py-24 overflow-x-hidden border-b-1 border-b-slate-900 bg-indigo-100 dark:bg-transparent" style={{
      ...
      <div className="mx-2 md:mx-16 mt-6 md:mt-20 md:w-1/2 my-auto">
        <h1 className="font-black mx-4 md:mx-12 md:leading-[4rem] text-4xl md:text-6xl border-l-8 border-transparent hover:border-pink-600 transition-[border] duration-300 pl-4">Say <span className="text-yellow-500 dark:text-yellow-400">Goodbye</span> to {" "}
          <span className="text-red-500">slow build times</span> & <span className="text-green-500">Hello</span> to {" "}
        ...
        <div className="border-1 border-green-900 bg-green-500/50 dark:bg-green-500/10 hover:bg-green-500/70 dark:hover:bg-green-500/30 transition-[background] duration-200 text-green-600 dark:text-green-500 backdrop-blur-sm font-bold text-xl md:text-2xl mt-4 mx-6 md:mx-16 w-48">
          <a href="/guide/getting-started" className="text-center my-auto w-full h-full block px-4 py-2">Get Started</a>
        </div>
      </div>
      <div className="md:w-1/2 rounded-lg md:rounded-r-none md:rounded-l-2xl bg-gradient-to-r from-purple-600 to-pink-600 h-96 mt-8 md:mt-24 mx-2 md:mx-0">
        <div class="md:m-8 shadow-2xl shadow-pink-600/20 group relative flex h-96 md:h-full w-full cursor-default flex-col overflow-hidden rounded-lg bg-white/70 dark:bg-black border-2 border-pink-600/50 hover:border-pink-600 transition-[border] duration-300">
