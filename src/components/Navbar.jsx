...
export default function Navbar(){
  return (
    <div className="w-auto backdrop-blur-lg fixed top-0 left-0 right-0 border-b-1 dark:border-slate-900 hover:border-pink-600 transition-[border] duration-300 z-[100]">
      ...
      <h1 className="cursor-default w-min text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 mr-auto hover:animate-pulse">Ree.js</h1>
