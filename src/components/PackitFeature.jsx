export default function RuntimesList() {
  return (
    <div className="md:max-w-xl drop-shadow-xl bg-slate-200 dark:bg-slate-900/50 border border-slate-900 hover:border-green-600 transition-[border] rounded-lg px-12 py-8">
