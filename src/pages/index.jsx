...
import "../../public/needed.css";

export const metadata = {
  title: "Reejs - Time to rethink React.",
  description: "It's time to level up your React game. Reejs is a React framework that makes it easy to build websites and web apps. Wait until you see how fast it is.",
  icon: "/favicon.ico",
  openGraph: {
    themeColor: "#805ad5",
    type: "website",
